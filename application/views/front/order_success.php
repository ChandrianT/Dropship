...
<h6>Total Pembayaran : $<?php echo $this->session->userdata("g_total");?></h6>
...
<h5 style="text-align: justify;">Kita akan segera menghubungi anda melalui email untuk informasi selanjutnya.</h5>			
		</div>
	</section> <!--/#cart_items-->
